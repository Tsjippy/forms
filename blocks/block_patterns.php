...
<!-- wp:tsjippy-forms/input {"type":"checkbox","name":"privacy_preference","options":[{"value":"hide_profile_picture","label":"Hide my profile picture"},{"value":"hide_name","label":"Hide my name"},{"value":"hide_location","label":"Hide my address"},{"value":"hide_phone","label":"Hide my phone numbers"},{"value":"hide_birthday","label":"Hide my birthday"},{"value":"hide_age","label":"Hide my age"},{"value":"hide_anniversary","label":"Hide my SIM Nigeria anniversary"}],"blockId":"157","hidden":true,"formbuilderChild":true} -->
<div class="wp-block-tsjippy-forms-input checkbox-wrapper" data-blockid="157"><label class="checkbox-wrapper-label" style="margin-right:5px"><input type="checkbox" name="privacy_preference" value="hide_profile_picture" class="formbuilder" autocomplete="on" data-blockid="157"/>Hide my profile picture</label><label class="checkbox-wrapper-label" style="margin-right:5px"><input type="checkbox" name="privacy_preference" value="hide_name" class="formbuilder" autocomplete="on" data-blockid="157"/>Hide my name</label><label class="checkbox-wrapper-label" style="margin-right:5px"><input type="checkbox" name="privacy_preference" value="hide_location" class="formbuilder" autocomplete="on" data-blockid="157"/>Hide my address</label><label class="checkbox-wrapper-label" style="margin-right:5px"><input type="checkbox" name="privacy_preference" value="hide_phone" class="formbuilder" autocomplete="on" data-blockid="157"/>Hide my phone numbers</label><label class="checkbox-wrapper-label" style="margin-right:5px"><input type="checkbox" name="privacy_preference" value="hide_birthday" class="formbuilder" autocomplete="on" data-blockid="157"/>Hide my birthday</label><label class="checkbox-wrapper-label" style="margin-right:5px"><input type="checkbox" name="privacy_preference" value="hide_age" class="formbuilder" autocomplete="on" data-blockid="157"/>Hide my age</label><label class="checkbox-wrapper-label" style="margin-right:5px"><input type="checkbox" name="privacy_preference" value="hide_anniversary" class="formbuilder" autocomplete="on" data-blockid="157"/>Hide my SIM Nigeria anniversary</label>%options-placeholder%</div>
<!-- /wp:tsjippy-forms/input -->
