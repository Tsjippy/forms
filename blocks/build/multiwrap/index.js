...
module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"tsjippy-forms/multi-wrap","version":"0.1.0","title":"Form Multi Input Wrapper","category":"form-blocks","icon":"forms","description":"Allows the submission of multiple elements which are grouped together. Children details for example where you can add multiple children.","example":{},"supports":{"html":false},"textdomain":"tsjippy","editorScript":"file:./index.js","attributes":{"add_button_content":{"type":"string","default":"+"},"remove_button_content":{"type":"string","default":"-"}}}');
