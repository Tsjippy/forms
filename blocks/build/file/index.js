...
/* harmony import */ var _shared_AddRequiredOptions__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../shared/AddRequiredOptions */ "./shared/AddRequiredOptions.js");
...
function Edit({
  ...
  const userMetaEnabled = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_5__.useSelect)(select => {
    const editor = select('core/block-editor');
    const parentId = editor.getBlockParentsByBlockName(clientId, 'tsjippy-forms/formbuilder')?.[0];
    return editor.getBlock(parentId)?.attributes?.user_meta === true;
  }, [clientId, attributes.required]);
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.Fragment, {
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0__.InspectorControls, {
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.PanelBody, {
        title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('File Input Settings', 'tsjippy'),
        ...
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_shared_AddRequiredOptions__WEBPACK_IMPORTED_MODULE_6__["default"], {
          clientId: clientId,
        ...
        }), !userMetaEnabled && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.TextControl, {
      ...
      ...blockProps,
      children: attributes.name == '' ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.TextControl, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Name", 'tsjippy'),
        value: name,
        onChange: value => setName(value)
...
module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"tsjippy-forms/file","version":"0.1.0","title":"File Upload Input","category":"form-blocks","icon":"forms","description":"File upload input. Supports single and multiple file uploads. Can also be used to upload images.","example":{},"supports":{"html":false},"render":"file:./render.php","textdomain":"tsjippy","editorScript":"file:./index.js","viewScript":"tsjippy_fileupload_script","attributes":{"name":{"type":"string","default":""},"disabled":{"type":"boolean","default":false},"multiple":{"type":"boolean","default":false},"required":{"type":"boolean","default":false},"targetDir":{"type":"string","default":""},"userId":{"type":"boolean","default":false},"library":{"type":"boolean","default":false},"options":{"type":"object","default":{}},"edit":{"type":"boolean","default":false},"metaKey":{"type":"string","default":""}}}');
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./block.json */ "./src/file/block.json");
/**
