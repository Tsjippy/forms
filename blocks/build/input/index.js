...
/* harmony import */ var _shared_usePrefill_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../shared/usePrefill.js */ "./shared/usePrefill.js");
...
function InputHtml({
  ...
  let prefillValue = '';
  if (!isSaving) {
    var prefill = (0,_shared_usePrefill_js__WEBPACK_IMPORTED_MODULE_3__.usePrefill)();
  ...
  if (['radio', 'checkbox'].includes(attributes.type)) {
    ...
    html = /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)("div", {
      ...(!renderMultiple ? blockProps : {}),
      className: `${blockProps.className} checkbox-wrapper`,
      "data-blockid": attributes.blockId,
      children: [options.map((option, index) => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.Fragment, {
        ...
        }), attributes.radioNewLine && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)("br", {})]
      }, `${option.value}-${index}-wrapper`)), isSaving && "%options-placeholder%"]
    });
  }
   ...
   */else if (attributes.type == 'textarea') {
    html = /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)("textarea", {
      ...(!renderMultiple ? blockProps : {}),
      type: attributes.type,
   ...
   * Others
   */else {
    html = /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)("input", {
      ...(!renderMultiple ? blockProps : {}),
      type: attributes.type,
      name: attributes.name,
      required: attributes.required,
   ...
   */
  return !isSaving && attributes.multiple && (!labelChild || ['text', "email", "tel", "url"].includes(attributes.type)) ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_Multiple_js__WEBPACK_IMPORTED_MODULE_1__.Multiple, {
    inner: html,
...
function Edit({
  ...
  const selectableOptions = ['radio', 'checkbox', 'select'].includes(attributes.type) ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.Fragment, {
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ToggleControl, {
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('One option per line', 'tsjippy'),
      checked: !!attributes.radioNewLine,
      onChange: radioNewLine => setAttributes({
        radioNewLine
      })
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.Fragment, {
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsxs)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InspectorControls, {
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsxs)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
        ...
        }), attributes.multiple && ['url', 'email', 'text', 'tel'].includes(attributes.type) && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ToggleControl, {
          label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Use the datalist value as value', 'tsjippy'),
          checked: !!attributes.datalistvalue,
          onChange: datalistvalue => setAttributes({
            datalistvalue
          })
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ToggleControl, {
      ...
      ...blockProps,
      children: ["Type: ", legend, /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx)("br", {}), attributes.name ? `Name: ${attributes.name}` : '', /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx)("br", {}), !attributes.type || !attributes.name ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.Fragment, {
...
module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"tsjippy-forms/input","version":"0.1.0","title":"Form Input","category":"form-blocks","icon":"forms","description":"Input element for a form","example":{},"supports":{"html":false},"textdomain":"tsjippy","editorScript":"file:./index.js","editorStyle":"file:./index.css","attributes":{"type":{"type":"string","default":""},"name":{"type":"string","default":""},"value":{"type":"string","default":""},"inputAttributes":{"type":"object","default":{}},"options":{"type":"array","default":[]},"options_dynamic":{"type":"string","default":""},"dynamic_value":{"type":"string","default":""},"add_button_content":{"type":"string","default":"+"},"remove_button_content":{"type":"string","default":"-"},"multiple":{"type":"boolean","default":false},"required":{"type":"boolean","default":false},"hasLabelParent":{"type":"boolean","default":false},"reminderConditions":{"type":"array","default":[]},"roles":{"type":"array","default":[]},"radioNewLine":{"type":"boolean","default":false},"datalistvalue":{"type":"boolean","default":false}}}');
