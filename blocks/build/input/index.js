...
function Edit({
  ...
  const getTypeOptions = () => {
    let typeOptions = [];
    ["button", "checkbox", "color", "date", "datetime-local", "email", "file", "hidden", "image", "month", "number", "password", "radio", "range", "reset", "search", "submit", "tel", "text", "time", "url", "week"].forEach(type => {
      typeOptions.push({
        label: type,
        value: type
      });
