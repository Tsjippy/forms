...
module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"tsjippy-forms/datalist","version":"0.1.0","title":"Datalist","category":"form-blocks","icon":"forms","description":"Datalist to be added to an form input","example":{},"supports":{"html":false},"textdomain":"tsjippy","editorScript":"file:./index.js","attributes":{"id":{"type":"string","default":""},"options":{"type":"array","default":[]},"options_dynamic":{"type":"string","default":""}}}');
